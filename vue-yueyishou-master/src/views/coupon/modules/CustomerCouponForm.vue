  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/com.ilhaha.yueyishou.coupon/customerCoupon/add",
          edit: "/com.ilhaha.yueyishou.coupon/customerCoupon/edit",
          queryById: "/com.ilhaha.yueyishou.coupon/customerCoupon/queryById"
        }
      }
    },
    computed: {
