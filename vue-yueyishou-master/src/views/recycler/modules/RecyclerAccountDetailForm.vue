    ...
    <j-form-container :disabled="formDisabled">
      <a-form-model ref="form" :model="model" :rules="validatorRules" slot="detail">
        <a-row>
          ...
          <a-col :span="24">
            <a-form-model-item label="交易类型：1-上缴平台费用 2-回收支付费用 3-提现" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="tradeType">
              <a-input v-model="model.tradeType" placeholder="请输入交易类型：1-上缴平台费用 2-回收支付费用 3-提现"  ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
...
<script>
  ...
  export default {
    name: 'RecyclerAccountDetailForm',
    components: {
    },
    props: {
      //表单禁用
    ...
    data () {
      return {
        ...
        validatorRules: {
           ...
           tradeType: [
              { required: true, message: '请输入交易类型：1-上缴平台费用 2-回收支付费用 3-提现!'},
           ],
           amount: [
        ...
        url: {
          add: "/com.ilhaha.yueyishou.recycler/recyclerAccountDetail/add",
          edit: "/com.ilhaha.yueyishou.recycler/recyclerAccountDetail/edit",
          queryById: "/com.ilhaha.yueyishou.recycler/recyclerAccountDetail/queryById"
        }
      }
    },
    computed: {
