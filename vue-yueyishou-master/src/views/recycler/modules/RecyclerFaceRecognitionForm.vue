    ...
    <j-form-container :disabled="formDisabled">
      <a-form-model ref="form" :model="model" :rules="validatorRules" slot="detail">
        <a-row>
          ...
          <a-col :span="24">
            <a-form-model-item label="识别日期" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="faceDate">
              <j-date placeholder="请选择识别日期" v-model="model.faceDate"  style="width: 100%" />
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
...
<script>
  ...
  export default {
    name: 'RecyclerFaceRecognitionForm',
    components: {
    },
    props: {
      //表单禁用
    ...
    data () {
      return {
        ...
        url: {
          add: "/com.ilhaha.yueyishou.recycler/recyclerFaceRecognition/add",
          edit: "/com.ilhaha.yueyishou.recycler/recyclerFaceRecognition/edit",
          queryById: "/com.ilhaha.yueyishou.recycler/recyclerFaceRecognition/queryById"
        }
      }
    },
    computed: {
