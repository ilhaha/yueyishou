        ...
        <a-row>
          <a-col :span="24">
            <a-form-model-item label="客户id" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="customerId">
              <a-input v-model="model.customerId" placeholder="请输入客户id"  ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
          ...
          <a-col :span="24">
            <a-form-model-item label="登录状态" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="status">
              <a-input-number v-model="model.status" placeholder="请输入登录状态" style="width: 100%" />
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/customerLoginLog/add",
          edit: "/customerLoginLog/edit",
          queryById: "/customerLoginLog/queryById"
        }
      }
    },
    computed: {
