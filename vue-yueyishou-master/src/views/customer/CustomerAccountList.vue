<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('customer_account')">导出</a-button>
    ...
    <customer-account-modal ref="modalForm" @ok="modalFormOk"></customer-account-modal>
  </a-card>
</template>
...
<script>
  ...
  export default {
    ...
    data () {
      return {
        description: 'customer_account管理页面',
        // 表头
        columns: [
          {
            title: '#',
    ...
    methods: {
      ...
      getSuperFieldList(){
        ...
        fieldList.push({type:'number',value:'totalAmount',text:'账户总余额'})
        fieldList.push({type:'number',value:'totalRecycleIncome',text:'回收总收入'})
