<template>
  <a-card :bordered="false">
    ...
    <customer-account-detail-modal ref="modalForm" @ok="modalFormOk"></customer-account-detail-modal>
  </a-card>
</template>
...
<script>
  ...
  import CustomerAccountDetailModal from './modules/CustomerAccountDetailModal'

  export default {
    name: 'CustomerAccountDetailList',
    ...
    data () {
      return {
        description: 'customer_account_detail管理页面',
        // 表头
        columns: [
          {
            title: '#',
